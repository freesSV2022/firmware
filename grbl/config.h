...
// NOTE: Defaults are set for a traditional 3-axis CNC machine. Z-axis first to clear, followed by X & Y.
  ...
  #define HOMING_CYCLE_1 ((1<<AXIS_2)|(1<<AXIS_4))     // MdB home Y en Y-slave.
  //#define HOMING_CYCLE_1 (1<<AXIS_1) // Home X axis  // OPTIONAL: uncomment to move only X at a time.
  #define HOMING_CYCLE_2 (1<<AXIS_1) // Home X axis  // OPTIONAL: uncomment to move only Y at a time.
...
//#define SPINDLE_PWM_MIN_VALUE 253 // Default disabled. Uncomment to enable. Must be greater than zero. Integer (1-255).
